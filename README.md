<video src="VideoDemo.mp4" controls="controls" width="100%"></video>
...
* **Código Original (v2.1):** [David Bacci (PBI-David)](https://github.com/PBI-David/Deneb-Showcase) - O verdadeiro gênio por trás da estrutura Vega deste Gantt.
